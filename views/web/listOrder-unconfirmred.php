...
$ar = $list->getListOrder_where(Session::get('userId'), '1');
...
?>
    <div class="user-order-body">
        ...
        <div class="user-order-body-footer">
            <a class="user-order-body-footer__buy button_outline" href="#<?php echo $lists['IdOrder'] ?>" onclick="cancelOrder(this);">
                Huỷ đơn hàng
            </a>
        </div>
    </div>
