...
$ar = $list->getListOrder_where(Session::get('userId'), '4');
...
?>
    <div class="user-order-body">
        ...
        <div class="user-order-body-footer">
            <a href="../../Classes/web/buyAgain.php?IdOrder=<?php echo $lists['IdOrder'] ?> " class="user-order-body-footer__buy">Mua lại</a>
        </div>
    </div>
